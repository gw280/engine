...
// The user_data received by the render callbacks refers to the FlutterWindowsEngine.
...
bool FlutterWindowsEngine::RunWithEntrypoint(const char* entrypoint) {
  ...
  FlutterRendererConfig renderer_config = surface_manager_ ? GetOpenGLRendererConfig() : GetSoftwareRendererConfig();
