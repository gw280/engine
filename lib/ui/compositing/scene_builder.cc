...
fml::RefPtr<EngineLayer> SceneBuilder::pushClipRect(double left,
  ...
  auto layer =
      std::make_shared<ClipRectLayer>(clipRect, clip_behavior);
  PushLayer(layer);
  return EngineLayer::MakeRetained(layer);
}
...
fml::RefPtr<EngineLayer> SceneBuilder::pushClipRRect(const RRect& rrect,
  ...
  Clip clip_behavior = static_cast<Clip>(clipBehavior);
  auto layer =
      std::make_shared<ClipRRectLayer>(rrect.sk_rrect, clip_behavior);
  PushLayer(layer);
  return EngineLayer::MakeRetained(layer);
}
...
fml::RefPtr<EngineLayer> SceneBuilder::pushClipPath(const CanvasPath* path,
  ...
  auto layer =
      std::make_shared<ClipPathLayer>(path->path(), clip_behavior);
  PushLayer(layer);
  return EngineLayer::MakeRetained(layer);
}
...
fml::RefPtr<EngineLayer> SceneBuilder::pushOpacity(int alpha,
                                                   ...
                                                   double dy) {
  auto layer =
      std::make_shared<OpacityLayer>(alpha, SkPoint::Make(dx, dy));
  PushLayer(layer);
  return EngineLayer::MakeRetained(layer);
}
...
fml::RefPtr<EngineLayer> SceneBuilder::pushColorFilter(
  ...
  auto layer =
      std::make_shared<ColorFilterLayer>(color_filter->filter());
  PushLayer(layer);
  return EngineLayer::MakeRetained(layer);
}
...
fml::RefPtr<EngineLayer> SceneBuilder::pushImageFilter(
  ...
  auto layer =
      std::make_shared<ImageFilterLayer>(image_filter->filter());
  PushLayer(layer);
  return EngineLayer::MakeRetained(layer);
}
...
void SceneBuilder::addPerformanceOverlay(uint64_t enabledOptions,
  ...
  auto layer =
      std::make_unique<PerformanceOverlayLayer>(enabledOptions);
